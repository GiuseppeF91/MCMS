...
package com.rjafri.mcms.veservice;
...
public class EffectType {
    ...
    public static final int EFFECT_COLOR_CUSTOM = 4;
    ...
    public static EffectType[] getEffects(Context context, int category) {
        ...
        switch (category) {
            case CATEGORY_IMAGE: {
                ...
                effects[4] = new EffectType(
                		context.getString(R.string.effect_color), EFFECT_COLOR_CUSTOM);
                break;
            }
